            ...
            <table class="table">
              ...
              <tbody>
                <tr>
                  <td>
                    <div class="d-flex align-items-center gap-2 ">
                      <img style="width: 100px; height: 100px; border-radius: 8px; object-fit: cover;" src="./assets/images/doctor-img.png" alt="">
                      <div>
                          <span style="color: #1E1E1E; font-size: 18px; " class="mt-1" >Jenny Wilson</span> <br>
                          <span style="color: #4F4F4F;" class="mt-2 d-block" >Psychologist</span>
                      </div>
                    </div>
                  </td>
                  <td>12345678</td>
                  <td>$200</td>
                  <td>
                      <svg width="14px" height="14px" xmlns="http://www.w3.org/2000/svg" fill="#187586" viewBox="0 0 576 512"><path d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"/></svg>
                      <svg width="14px" height="14px" xmlns="http://www.w3.org/2000/svg" fill="#187586" viewBox="0 0 576 512"><path d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"/></svg>
                      <svg width="14px" height="14px" xmlns="http://www.w3.org/2000/svg" fill="#187586" viewBox="0 0 576 512"><path d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"/></svg>
                      <svg width="14px" height="14px" xmlns="http://www.w3.org/2000/svg" fill="#187586" viewBox="0 0 576 512"><path d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"/></svg>
                      <svg width="14px" height="14px" xmlns="http://www.w3.org/2000/svg" fill="#187586" viewBox="0 0 576 512"><path d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"/></svg>
                  ...
                  <td>
                    <div class="d-flex align-items-center gap-3 ">
                      <a href="{{ route('doctor.profile') }}" class="view-profile-btn">
                          View Profile
                      </a>
                      <div data-bs-toggle="modal" data-bs-target="#exampleModal" class="make-appointment-btn">
                         Make An Appointment
                      </div>
                    </div>
                  </td>
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex align-items-center gap-3 ">
                      <a href="./DoctorProfile.html" class="view-profile-btn">
                          View Profile
                      </a>
                      <div data-bs-toggle="modal" data-bs-target="#exampleModal" class="make-appointment-btn">
                         Make An Appointment
        ...
        <div class="modal-body">
          <form class="tm-form">
              ...
              <div class="form-field-wrapper">
                  ...
                  <div class="form-group">
                      <label for="my-input">Therapy Type</label>
              ...
              <button style="background-color: #187586;" class="tm-dashboard-btn" type="submit">Make Appointment</button>
          </form>
        </div>
