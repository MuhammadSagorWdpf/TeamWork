                ...
                <tr>
                  <td>
                    <div class="d-flex align-items-center gap-2 ">
                      <img style="width: 40px; height: 40px; object-fit: cover;" src="./assets/images/user.png" alt="">
                      
                        <div>
                          <span style="color: #1E1E1E; font-size: 18px; " class="mt-1" >Dr. Jenny Wilson</span>
                          <div class="mt-1" >Psychologist</div>
                        </div>
                    </div>
                  </td>
                  <td>12345678</td>
                  ...
                  <td style="color: #187586;" >
                      Pending
                  </td>
                  <td>
                    <div class="d-flex align-items-center gap-2 ">
                      <svg data-bs-toggle="modal" data-bs-target="#exampleModal" style="cursor: pointer;"
                      xmlns="http://www.w3.org/2000/svg"
                      width="18"
                      height="18"
                      viewBox="0 0 18 18"
