...
<div class="layout-container">
  ...
  <div class="main-content setting mx-5">
    <div class="main-content-container"> 
        ...
        <div class="section-title mt-3">Doctor Setting</div>
        
          <form class="tm-form mt-3" action="{{ route('setting.update', $setting->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
              <div class="form-field-wrapper">
                  <div class="form-group">
                      <label for="my-input">First Name</label>
                      <input class="form-control" type="text" name="first_name" required placeholder="First Name" value="{{ old('first_name', $setting->first_name) }}">
                      @error('first_name')
                  ...
                  <div class="form-group">
                      ...
                      <input class="form-control" type="text" name="last_name" required placeholder="Last Name" value="{{ old('last_name', $setting->last_name) }}">
                      @error('last_name')
                          <span class="text-danger">{{ $message }}</span>
                      @enderror
                  </div>
              ...
              <div class="form-field-wrapper">
                  <div class="form-group">
                      ...
                      <input class="form-control" type="tel" name="phone_number" required placeholder="+23122123" value="{{ old('phone_number', $setting->phone_number) }}">
                      @error('phone_number')
                          <span class="text-danger">{{ $message }}</span>
                      @enderror
                  </div>
              ...
              <div class="form-field-wrapper">
                  <div class="form-group">
                      ...
                      <div class="date-picker-container">
                          <input style="width: 100%;" id="date-input" name="dob" placeholder="DD/MM/YY" type="text" value="{{ old('dob', $setting->dob) }}">
                          @error('dob')
                              <span class="text-danger">{{ $message }}</span>
                          @enderror
                      </div>
                  ...
                  <div class="form-group">
                      ...
                      <select name="gender" style="height: 60px; border-color: #D5D8E2;" class="form-select type" aria-label="Default select example">
                          <option value="{{ old('gender', $setting->gender) }}">{{ old('gender', $setting->gender) }}</option>
              ...
              <div class="tm-settings-img-upload-area">
                  <div class="d-flex gap-5">
                    <div class="tm-settings-img-space">
                      <img src="{{ asset('doctor/profile/'.$setting->profile_image) }}" alt="" id="previewImage" srcset="">
                    </div>
