                    ...
                    <div class="notify-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            ...
                            <path
                                ...
                                stroke="#1F305E" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        </svg>
                    </div>
                    <div class="notify-details">
                        <h6 class="notify-title">New Client Appointment</h6>
                        <a class="{{ $notification->read_at ? 'text-dark' : 'text-warning' }}" href="{{ route('markAsRead', $notification->id) }}">{{ $notification->data['email'] }}</a>   
                    </div>
