 ...
 <div class="main-content">
        ...
        <div class="profile-container">
          <div class="profile-top">
            <div class="img">
              <img src="{{asset('admin-assets/images/doctor.png')}}" alt="" />
            </div>
          ...
          <div class="profile-appointments mt-4 mt-md-5">
            ...
            <div class="profile-appointments-items mt-4">
              <div class="item">
                <div class="date">
                  <div class="date-text">July 30, 2024</div>
                ...
                <div class="time">
                  ...
                  <span>08:30 am - 10:30 am</span>
                </div>
                <div class="client">Client - Jacob Jones</div>
              </div>
              <div class="item">
                <div class="date">
                  <div class="date-text">July 30, 2024</div>
