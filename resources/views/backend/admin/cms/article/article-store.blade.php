   ...
   <!-- sidebar end -->
      ...
      <div class="main-content">
        <div class="main-content-container">
          ...
          <form class="tm-form mt-5 px-5" action="{{ route('article.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-field-wrapper">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="section" required placeholder="Enter your section">
                </div>
            </div>
                <div class="form-field-wrapper">
                    <div class="form-group">
