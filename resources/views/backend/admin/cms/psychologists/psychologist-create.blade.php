   ...
   <!-- sidebar end -->
      ...
      <div class="main-content">
        <div class="main-content-container">
          ...
          <form class="tm-form mt-2 px-5" method="POST" action="{{ route('psychologists.store') }}">
            @csrf
            <div class="form-field-wrapper">
                ...
                <div class="form-field-wrapper">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="btn_text" required placeholder="Enter your btn text" value="{{ old('btn_text') }}">
                        @error('btn_text')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" name="card_title_1" id="" class="form-control" placeholder="Enter your card title 1" value="{{ old('card_title_1') }}">
                        @error('card_title_1')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-field-wrapper">
                    <div class="form-group">
                        ...
                        <input type="text" name="card_title_2" id="" class="form-control" placeholder="Enter your card title 2" value="{{ old('card_title_2') }}">
                        @error('card_title_2')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" name="card_title_3" id="" class="form-control" placeholder="Enter your card title 3" value="{{ old('card_title_3') }}">
                        @error('card_title_3')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-field-wrapper">
                    <div class="form-group">
                        ...
                        <textarea name="card_desc_1" id="" class="form-control" placeholder="Enter your card description 1">{{ old('card_desc_1') }}</textarea>
                        @error('card_desc_1')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <textarea name="card_desc_2" id="" class="form-control" placeholder="Enter your card description 2">{{ old('card_desc_2') }}</textarea>
                        @error('card_desc_2')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="form-field-wrapper">
                    <div class="form-group">
                        ...
                        <textarea name="card_desc_3" id="" class="form-control" placeholder="Enter your card description 3">{{ old('card_desc_3') }}</textarea>
                        @error('card_desc_3')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
