      ...
      <div class="main-content">
        <div class="main-content-container">
          ...
          <div class="section-title mt-4 d-flex justify-content-between">
            <h2>Home Services Create</h2>
            <a href="{{ route('services') }}" class="btn btn-sm btn-primary">Back</a>
          </div>
          <form class="tm-form mt-5 px-5" action="{{ route('services.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="form-field-wrapper">
                ...
                <div class="form-field-wrapper">
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="card_title_1" required placeholder="Enter your card_title_1">
                    </div>
                    <div class="form-group">
                        <label for="my-input">Card Title 2</label>
                        <input class="form-control" type="text" name="card_title_2" required placeholder="Enter your card_title_2">
                    </div>
                </div>
                <div class="form-field-wrapper">
                    <div class="form-group">
                        <label for="my-input">Card Description 1</label>
                        <textarea class="form-control" name="card_desc_1" required placeholder="Enter your card_desc_2"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="my-input">Card Description 2</label>
                        <textarea class="form-control" name="card_desc_2" required placeholder="Enter your card_desc_2"></textarea>
                    </div>
                </div>
                <div class="form-group">
