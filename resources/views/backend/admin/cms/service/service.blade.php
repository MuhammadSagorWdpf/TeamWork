  ...
  <div class="main-content">
    <div class="main-content-container">
          ...
          <div class="section-title mt-4 d-flex justify-content-between">
            <h2>Home Service</h2>
            <a href="{{ route('admin.services.create') }}" class="btn btn-sm btn-primary">Create</a>
          </div>
              ...
              <table class="table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>{{ Str::limit($service->card_title_1, 20) }}</td>
                    <td>{{ Str::limit($service->card_desc_1, 20) }}</td>
                    <td>
                      <img src="{{ asset('service/'.$service->images)}}" alt="" width="50" height="50">
                    </td>
                    <td class="d-flex justify-center gap-3">
                        <a href="{{ route('service.edit', $service->id) }}"><i class="fa-solid fa-pen-to-square"></i></a>
                    </td>
                  </tr>                       
