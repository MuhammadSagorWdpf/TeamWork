              ...
              <table class="table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>{{ Str::limit($banners->title, 20) }}</td>
                    <td>{{ Str::limit($banners->sub_title, 20) }}</td>
                    <td>{{ Str::limit($banners->description, 20) }}</td>
                    <td>{{ $banners->btn_text }}</td>
                    <td>
                      <img src="{{ asset('banners/'.$banners->images)}}" alt="" width="50" height="50">
                    </td>
                    <td class="d-flex justify-center gap-3">
                        <a href="{{ route('banner.edit', $banners->id) }}"><i class="fa-solid fa-pen-to-square"></i></a>
                    </td>
                  </tr>                       
