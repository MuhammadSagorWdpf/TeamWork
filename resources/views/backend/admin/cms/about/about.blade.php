  ...
  <div class="main-content">
    <div class="main-content-container">
          ...
          <div class="section-title mt-4 d-flex justify-content-between">
            <h2>Abouts</h2>
            <a href="{{ route('abouts.create') }}" class="btn btn-sm btn-primary">Create</a>
          </div>
              ...
              <table class="table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>{{ Str::limit($abouts->title, 20) }}</td>
                    <td>{{ Str::limit($abouts->sub_title, 20) }}</td>
                    <td>{{ Str::limit($abouts->short_description, 20) }}</td>
                    ...
                    <td class="d-flex justify-center gap-3">
                        <a href="{{ route('abouts.edit', $abouts->id) }}"><i class="fa-solid fa-pen-to-square"></i></a>
