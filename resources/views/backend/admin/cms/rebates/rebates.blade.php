  ...
  <div class="main-content">
    <div class="main-content-container">
          ...
          <div class="section-title mt-4 d-flex justify-content-between">
            <h2>Rebates</h2>
            <a href="{{ route('rebates.create') }}" class="btn btn-sm btn-primary">Create</a>
          </div>
              ...
              <table class="table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>{{ Str::limit($rebates->title, 20) }}</td>
                    <td>{{ Str::limit($rebates->short_description, 20) }}</td>
                    <td>{{ Str::limit($rebates->card_title_1, 20) }}</td>
                    <td>{{ $rebates->card_desc_1 }}</td>
                    <td>
                      <img src="{{ asset('rebate/'.$rebates->images)}}" alt="" width="50" height="50">
                    </td>
                    <td class="d-flex justify-center gap-3">
                        <a href="{{ route('rebates.edit', $rebates->id) }}"><i class="fa-solid fa-pen-to-square"></i></a>
                    </td>
                  </tr>                       
