  ...
  <div class="main-content">
    <div class="main-content-container">
          ...
          <div class="section-title mt-4 d-flex justify-content-between">
            ...
            <a href="{{ route('faqs.create') }}" class="btn btn-sm btn-primary">Create</a>
          </div>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="d-flex justify-center gap-3">
                        <a href="{{ route('faq.edit', $faq->id) }}"><i class="fa-solid fa-pen-to-square"></i></a>
                        <a onclick="deleteData(event)" href="{{ route('faq.delete', $faq->id) }}"><i class="fa-solid fa-trash"></i></a>
                    </td>
                  </tr>  
                  @endforeach                      
